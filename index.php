...
<?php 
      ...
      ?>
        ...
        <main>
          <p1>again Insert Your MongoDB.Atlas connection string for your application code (while getting connection string Driver should be PHP and add your password in connection string the way it instructed in cloud.mongodb/connect).</p1> 
          <div class ="form">
              <form action="" method="POST" name="login" >
